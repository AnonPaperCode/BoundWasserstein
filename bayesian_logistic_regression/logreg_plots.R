...
ds1_bounds_plot
# ggsave(filename = "images/logistic_regression/ds1_bounds_plot.pdf", plot = ds1_bounds_plot, width = 4, height = 4)
...
combined_ub_lb_plot
# ggsave(filename = "images/logistic_regression/combined_ub_lb_plot2.pdf", plot = combined_ub_lb_plot, width = 13, height = 4)
